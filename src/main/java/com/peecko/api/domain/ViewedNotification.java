...
public class ViewedNotification implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "notification_viewed_gen")
    @SequenceGenerator(name = "notification_viewed_gen", sequenceName = "notification_viewed_seq")
    @Column(name = "id")
    private Long id;
